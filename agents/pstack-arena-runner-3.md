---
name: pstack-arena-runner-3
description: "arena skill panel slot 3: builds one competing candidate in its own worktree. Give each runner a different model for diversity. Disable a runner to shrink the panel."
model: "@task"
blocking: false
spawns: "*"
---

# P-Stack arena runner 3
