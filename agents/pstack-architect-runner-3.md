---
name: pstack-architect-runner-3
description: "architect skill panel slot 3: produces one design package. Give each runner a different model for diversity. Disable a runner to shrink the panel."
model: "@task"
blocking: false
spawns: "*"
---

# P-Stack architect runner 3
