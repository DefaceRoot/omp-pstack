...
The sequencing complement to `skill://principle-prove-it-works`, which keeps each check real, and `skill://principle-build-the-lever`, which makes the per-unit check cheap.
