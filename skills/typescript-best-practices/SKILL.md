...
Apply `skill://principle-type-system-discipline` first; this skill grounds it in TypeScript syntax.
...
| Boundary validation | Validate where data crosses in; trust types inside. See `skill://principle-boundary-discipline`. |
