...
- Existing-skill-first: propose `new project SKILL.md:` only when no existing skill is a real home, the pattern recurs, and the topic deserves its own skill.
...
- "we renamed a specific model selector in `encodingForModel`"
...
| <new pattern, no existing skill is a real home> | <draft a new project SKILL.md> | <new project SKILL.md: <kebab-name>> |
