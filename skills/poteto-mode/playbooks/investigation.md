...
No PR, no babysit, no `skill://architect` unless the investigation precedes a code change. If it does, hand back to the user and re-route to Bug fix (`skill://poteto-mode/playbooks/bug-fix.md`) or Feature (`skill://poteto-mode/playbooks/feature.md`).
