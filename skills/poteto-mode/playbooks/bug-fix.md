...
3. Plan the fix. If it crosses a function boundary, run `skill://architect` first. Delegate implementation through native `task` with `agent: "pstack-bug-fix"` and a specific scope. Review the diff.
