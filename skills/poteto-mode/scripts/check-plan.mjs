...
const LANES = "Ten lanes with the `pstack-swarm-worker` agent at the PR head";
const SUB_BLOCKS = [
	"Depends on.",
	"Files.",
	"Build.",
...
const PROGRAM_MARKERS = ["/goal", "skill://poteto-mode/playbooks/opening-a-pr.md", /30[- ]minute/, "status message"];
