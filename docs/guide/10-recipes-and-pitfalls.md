...
![She tastes a finished dish while robots cook from a recipe box, with pinned cards reading /how, /tdd, and /goal set above the counter.](./images/recipes.jpg)
...
- **A vague finish condition.** "make it better" gives `/goal set` nothing to check. Give a command or artifact that can pass or fail.
